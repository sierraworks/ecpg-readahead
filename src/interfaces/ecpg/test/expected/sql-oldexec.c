...
#line 50 "oldexec.pgc"
	...
	{ ECPGopen(__LINE__, 0, 1, NULL, 1, 0, ECPGcs_no_scroll, 1, "CUR", ECPGst_normal, "declare CUR no scroll cursor for $1", 
...
#line 71 "oldexec.pgc"
	...
	{ ECPGopen(__LINE__, 0, 1, NULL, 1, 0, ECPGcs_no_scroll, 1, "CUR3", ECPGst_normal, "declare CUR3 no scroll cursor for $1", 
	ECPGt_char_variable,(ECPGprepared_statement(NULL, "f", __LINE__)),(long)1,(long)1,(1)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
