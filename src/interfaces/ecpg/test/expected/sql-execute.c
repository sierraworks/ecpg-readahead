...
#line 49 "execute.pgc"
	...
	/* declare CUR no scroll cursor for $1 */
#line 50 "execute.pgc"


	{ ECPGopen(__LINE__, 0, 1, NULL, 0, 0, ECPGcs_no_scroll, 1, 1, 0, "CUR", ECPGst_normal, "declare CUR no scroll cursor for $1", 
...
#line 71 "execute.pgc"
	...
	/* declare CUR2 no scroll cursor for $1 */
#line 72 "execute.pgc"


	{ ECPGopen(__LINE__, 0, 1, NULL, 0, 0, ECPGcs_no_scroll, 1, 1, 0, "CUR2", ECPGst_normal, "declare CUR2 no scroll cursor for $1", 
	ECPGt_char_variable,(ECPGprepared_statement(NULL, "f", __LINE__)),(long)1,(long)1,(1)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
...
#line 82 "execute.pgc"
	...
	{ ECPGclose(__LINE__, 0, 1, NULL, 0, "CUR2", ECPGst_normal, "close CUR2", ECPGt_EOIT, ECPGt_EORT);
#line 88 "execute.pgc"
