...
#line 24 "outofscope.pgc"
 ...
 /* declare mycur no scroll cursor for select * from a1 */
...
open_cur1(void)
{
	{ ECPGopen(__LINE__, 0, 1, NULL, 0, 0, ECPGcs_no_scroll, 1, "mycur", ECPGst_normal, "declare mycur no scroll cursor for select * from a1", ECPGt_EOIT, 
