...
#line 57 "dyntest.pgc"
  ...
  /* declare MYCURS no scroll cursor for $1 */
#line 58 "dyntest.pgc"


  { ECPGopen(__LINE__, 0, 1, NULL, 0, 0, ECPGcs_no_scroll, 1, 1, 0, "MYCURS", ECPGst_normal, "declare MYCURS no scroll cursor for $1", 
...
#line 60 "dyntest.pgc"
  ...
  while (1)
    {
      { ECPGfetch(__LINE__, 0, 1, NULL, 0, ECPGc_forward, "1", 0, "MYCURS", ECPGst_normal, "fetch in MYCURS", ECPGt_EOIT, 
...
#line 187 "dyntest.pgc"
  ...
  { ECPGclose(__LINE__, 0, 1, NULL, 0, "MYCURS", ECPGst_normal, "close MYCURS", ECPGt_EOIT, ECPGt_EORT);
