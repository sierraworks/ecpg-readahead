...
#line 95 "sqlda.pgc"
	...
	strcpy(msg, "declare");
	ECPG_informix_reset_sqlca(); /* declare mycur1 no scroll cursor for $1 */
#line 98 "sqlda.pgc"


	strcpy(msg, "open");
	{ ECPGopen(__LINE__, 1, 1, NULL, 0, 0, ECPGcs_no_scroll, 1, 1, 0, "mycur1", ECPGst_normal, "declare mycur1 no scroll cursor for $1", 
...
#line 103 "sqlda.pgc"
	...
	{
		strcpy(msg, "fetch");
		{ ECPGfetch(__LINE__, 1, 1, NULL, 0, ECPGc_forward, "1", 0, "mycur1", ECPGst_normal, "fetch 1 from mycur1", ECPGt_EOIT, 
...
#line 115 "sqlda.pgc"
	...
	strcpy(msg, "close");
	{ ECPGclose(__LINE__, 1, 1, NULL, 0, "mycur1", ECPGst_normal, "close mycur1", ECPGt_EOIT, ECPGt_EORT);
#line 118 "sqlda.pgc"
...
#line 132 "sqlda.pgc"
	...
	strcpy(msg, "declare");
	ECPG_informix_reset_sqlca(); /* declare mycur2 no scroll cursor for $1 */
#line 135 "sqlda.pgc"


	strcpy(msg, "open");
	{ ECPGopen(__LINE__, 1, 1, NULL, 0, 0, ECPGcs_no_scroll, 1, 1, 0, "mycur2", ECPGst_normal, "declare mycur2 no scroll cursor for $1", 
...
#line 140 "sqlda.pgc"
	...
	{
		strcpy(msg, "fetch");
		{ ECPGfetch(__LINE__, 1, 1, NULL, 0, ECPGc_forward, "1", 0, "mycur2", ECPGst_normal, "fetch from mycur2", ECPGt_EOIT, 
	ECPGt_sqlda, &outp_sqlda, 0L, 0L, 0L, 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);
#line 146 "sqlda.pgc"
...
#line 152 "sqlda.pgc"
	...
	strcpy(msg, "close");
	{ ECPGclose(__LINE__, 1, 1, NULL, 0, "mycur2", ECPGst_normal, "close mycur2", ECPGt_EOIT, ECPGt_EORT);
#line 155 "sqlda.pgc"
