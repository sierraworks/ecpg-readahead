...
#line 98 "sqlda.pgc"
	...
	strcpy(msg, "open");
	{ ECPGopen(__LINE__, 1, 1, NULL, 0, 0, ECPGcs_no_scroll, "mycur1", ECPGst_normal, "declare mycur1 no scroll cursor for $1", 
...
#line 135 "sqlda.pgc"
	...
	strcpy(msg, "open");
	{ ECPGopen(__LINE__, 1, 1, NULL, 0, 0, ECPGcs_no_scroll, "mycur2", ECPGst_normal, "declare mycur2 no scroll cursor for $1", 
