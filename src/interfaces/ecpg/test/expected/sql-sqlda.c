...
#line 97 "sqlda.pgc"
	...
	strcpy(msg, "declare");
	/* declare mycur1 no scroll cursor for $1 */
#line 100 "sqlda.pgc"


	strcpy(msg, "open");
	{ ECPGopen(__LINE__, 0, 1, NULL, 0, 0, ECPGcs_no_scroll, 1, 1, 0, "mycur1", ECPGst_normal, "declare mycur1 no scroll cursor for $1", 
...
#line 105 "sqlda.pgc"
	...
	{
		strcpy(msg, "fetch");
		{ ECPGfetch(__LINE__, 0, 1, NULL, 0, ECPGc_forward, "1", 0, "mycur1", ECPGst_normal, "fetch 1 from mycur1", ECPGt_EOIT, 
...
#line 117 "sqlda.pgc"
	...
	strcpy(msg, "close");
	{ ECPGclose(__LINE__, 0, 1, NULL, 0, "mycur1", ECPGst_normal, "close mycur1", ECPGt_EOIT, ECPGt_EORT);
#line 120 "sqlda.pgc"
...
#line 132 "sqlda.pgc"
	...
	strcpy(msg, "declare");
	/* declare mycur2 no scroll cursor for $1 */
#line 135 "sqlda.pgc"


	strcpy(msg, "open");
	{ ECPGopen(__LINE__, 0, 1, NULL, 0, 0, ECPGcs_no_scroll, 1, 1, 0, "mycur2", ECPGst_normal, "declare mycur2 no scroll cursor for $1", 
...
#line 138 "sqlda.pgc"
	...
	strcpy(msg, "fetch");
	{ ECPGfetch(__LINE__, 0, 1, NULL, 0, ECPGc_forward, "all", 0, "mycur2", ECPGst_normal, "fetch all from mycur2", ECPGt_EOIT, 
	ECPGt_sqlda, &outp_sqlda, 0L, 0L, 0L, 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);
#line 141 "sqlda.pgc"
...
#line 141 "sqlda.pgc"
	...
	strcpy(msg, "close");
	{ ECPGclose(__LINE__, 0, 1, NULL, 0, "mycur2", ECPGst_normal, "close mycur2", ECPGt_EOIT, ECPGt_EORT);
#line 157 "sqlda.pgc"
